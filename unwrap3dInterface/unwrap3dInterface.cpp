...
extern "C" PyObject*
unwrap3d(PyObject* self, PyObject* args, PyObject* keywords)
{
        ...
        cout << "beginning unwrap algorithm" << endl;
        ...
        cout << "finished unwrap algorithm" << endl;
        return PyUnwrappedVolume;
}

static PyMethodDef module_methods[] = {
    {"unwrap3d",(PyCFunction)unwrap3d,METH_VARARGS,"python wrapper for unwrap3d"},
    {NULL}
};
...
initunwrap3d(void)
{
    (void)Py_InitModule("unwrap3d",module_methods);
    import_array();
}
